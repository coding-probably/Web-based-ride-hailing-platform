        ...
        <>
            <div>
                ...
                <div className="flex justify-center pt-2">
                    <h3 className="text-xl font-semibold mb-0">Confirming Your Ride</h3>
                </div>
                ...
                <div className="flex flex-col justify-between items-center">
                    ...
                    <div className="w-full mt-5 flex justify-center">
                        <button
                        onClick={() => {
                            props.setVehicleFinding(true);
                            props.setConfirmRidePanel(false);
                            props.createRide();
          
                        }} className="w-3/5 rounded-lg bg-[#10b461] text-white font-semibold h-10">Confirm</button>
                    </div>
